...
\subsubsection{Distribución triangular}
\par La distribución de corrientes binómica define el polinomio como un binomio elevado a una potencia y desarrollado según la fórmula de Newton: \citep{Cardama2002}
...
\par En la sección anterior se hicieron mención a los conceptos \textit{broadsire} y \textit{endfire}. Estos conceptos definen los casos en los que el máximo de radiación sea transversal (\textit{broadsire}) o longitudinal (\textit{endfire}) con respecto al eje de la agrupación. \cite{Cardama2002}
...
\subsection{Agrupaciones longitudinales}
...
\begin{figure}[h]
    \centering
        \includegraphics[width=0.9\textwidth]{archivos/array/side}
        \caption{Comparación de radiación \textit{broadside} y \textit{endfire}}
        \label{fig:side}
\end{figure}

\section{Tipos de distribuciones}
\
