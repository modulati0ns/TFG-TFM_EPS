...
\subsection{Patrón de radiación}
\par En cuanto a los patrones de radiación, se puede observar se puede observar un comportamiento más directivo con unos lóbulos laterales y trasero de bastante magnitud en relación al lóbulo principal para el plano H, mientras que en el plano E se observa un comportamiento completamente omnidireccional para el plano superior del array. La directividad en el ángulo de máxima radiación observada es de 7.64 dB.
\\
\subsubsection{Plano E}
\begin{figure}[H]
    \centering
...
\subsection{Patrón de radiación}
\par El patrón de radiación que se observa es completamente simétrico en el plano H, donde se encuentra un lóbulo principal poco con un máximo de 10.74 dB de directividad. Existen también dos lóbulos laterales de menor intensidad. En cuanto al plano E se puede observar un patrón de directividad más omnidireccional ya que los lóbulos laterales y traseros están más integrados en el patrón y no se presencian tantas zonas de radiación nula como en el plano H. Se hace presente la asimetría en el plano E probablemente debido a los acoplos de energía entre la línea de alimentación y el parche inferior derecho.
\\
\subsubsection{Plano E}
\begin{figure}[H]
    \centering
        \includegraphics[width=0.7\textwidth]{archivos/analisis/2x21/42}
...
\begin{figure}[H]
    \centering
        \includegraphics[width=0.7\textwidth]{archivos/analisis/2x21/52}
...
\subsection{Patrón de radiación}
\par El patrón de directividad que encontramos en el array 2x2 a 6 GHz difiere mucho del que encontramos en la misma configuración a 2.4 GHz. Se puede comprobar un aumento de 2 dB de directividad hasta los 12.88 dB, así como comportamientos asimétricos en ambos planos de radiación. Al igual que en el caso a 2.4 GHz, existe un gran acoplamiento de energía entre la línea principal de alimentación y el parche inferior derecho, causa principal de de las asimetría en el plano E de radiación.
\\
\subsubsection{Plano E}
\begin{figure}[H]
    \centering
        \includegraphics[width=0.75\textwidth]{archivos/analisis/2x22/42}
...
\begin{figure}[H]
    \centering
        \includegraphics[width=0.75\textwidth]{archivos/analisis/2x22/52}
...
\subsection{Patrón de radiación}
\par Al duplicar la fila que se poseía en el array 4x1 se ha obtenido el mismo patrón de directividad que se obtuvo en esta para el plano H, pero con una mayor área de radiación en los lóbulos laterales, aumentando de cobertura en estas zonas. La directividad obtenida en el ángulo de máxima radiación es de 13.97 dB. En el plano H vemos un patrón casi omnidireccional, como ocurría en el array 4x1 pero con ciertos nulos creando lóbulos laterales más definidos.
\\
\subsubsection{Plano E}
\begin{figure}[H]
    \centering
...
\subsection{Patrón de radiación}
\par Como es corriente al aumentar la frecuencia, se ha notado un incremento de la directividad en los planos E y H con respecto a la misma configuración a 2.4 GHz, hasta llegar a los 15.56 dB. Se puede observar la asimetría presente en el plano E, la cual es debida tanto a la falta del otro conjunto de dos filas que harían el array simétrico, como, posiblemente, al acoplamiento de radiación entre los parches inferiores y las líneas de alimentación.
\\
\subsubsection{Plano E}
\begin{figure}[H]
    \centering
...
\subsection{Patrón de radiación}
\par En el plano H de radiación encontramos un patrón caracterizado por su lóbulo principal y poca directividad en los lóbulos laterales así como la difusión de los lóbulos secundarios y traseros que si encontrábamos en la configuración 4x4 a 2.4 GHz. Por otra parte, en el plano E encontramos un patrón bastante irregular probablemente debido a la influencia de la línea de transmisión sobre la radiación de la antena.
\\
\subsubsection{Plano E}
\begin{figure}[H]
    \centering
...
\subsection{Patrón de radiación}
\par El patrón de radiación se caracteriza en su plano H por poseer una gran directividad, de 10.55 dB, para su lóbulo principal así como una correcta simetría de este. En el plano E se observa un comportamiento omnidireccional debido a la no existencia de parches que realicen interferencia sobre la señal emitida.
\\
\subsubsection{Plano E}
\begin{figure}[H]
    \centering
...
\subsection{Pérdidas de retorno}
\par La curva del parámetro $S_{11}$ del Array 2x2 a 27 GHz, arroja un valor pico de -21.59 dB y un ancho de banda de 792.4 MHz, desde los 26.612 GHz hasta los 27.404 GHz, lo que equivale a un 2.93\% de la frecuencia de trabajo.
\\
\begin{figure}[H]
    \centering
...
\newpage
\subsection{Reactancia}
\par La curva de reactancia arroja un valor a la frecuencia de trabajo de -4.49 $\Omega$.
\\
\begin{figure}[H]
    \centering
...
\subsection{Resistencia}
\par La parte real de la impedancia ofrece un valor a la frecuencia de trabajo de 43.61 $\Omega$.
\\
\begin{figure}[H]
    \centering
...
\subsection{Patrón de radiación}
\par El plano de radiación H, ha presentado en esta ocasión severas asimetrías, pero una gran directividad para su lóbulo principal. En el caso del plano E, se observa una mayor simetría, y un leve aparición de lóbulos laterales. 
\\
\subsubsection{Plano E}
\begin{figure}[H]
    \centering
...
\newpage
\subsection{Radiación 3D}
\par Se puede suponer cual es la forma básica que debería tener una configuración 2x2, teniendo en cuenta el estudio realizado a la antena de 2.4 GHz en la sección \ref{rad3d2x21}. En este caso, se observan deformidades, que dejan mucho que desear sobre el patrón de radiación de esta antena, sobretodo en el plano H, que hace que los lóbulos laterales en su plano aumenten de manera considerada.

\begin{figure}[H]
     \centering
     \begin{subfigure}[b]{0.7\textwidth}
         \centering
         \includegraphics[width=0.8\textwidth]{archivos/analisis/2x23/6}
         \caption{Representación isométrica del diagrama de radiación 3D}
         \label{fig:3d12x23}
     \end{subfigure}
     \hfill
     \begin{subfigure}[b]{0.7\textwidth}
         \centering
         \includegraphics[width=0.8\textwidth]{archivos/analisis/2x23/7}
         \caption{Representación superior del diagrama de radiación 3D}
         \label{fig:3d22x23}
     \end{subfigure}
     \hfill
...
\subsection{Resumen}
\par El Array 2x2 a 27 GHz se ha caracterizado por poseer una buena eficiencia de radiación, así como sus pérdidas de retorno y su directividad. Pero ha dejado mucho que desear respecto a sus patrón de radiación, el cual ha presentado diversas anomalías, no presentes en la misma configuración para otras frecuencias. Se ha de tener en cuenta que sólo para esta configuración, se han aplicado unas modificaciones especiales. 
\\
\par En el momento de diseñar la antena y ver los resultados, se observó como, al diseñar el array con una separación entre los parches inferiores y superiores de $0.7\Lambda_{0}$, existía mucho acoplo de energía entre la línea de alimentación principal y el parche inferior derecho. Es por esto que se decidió aumentar el valor de la distancia de separación vertical a $0.9\Lambda_{0}$, de forma que aún se evitaba la formación de \textit{grating lobes}, y a la vez se conseguían mejores resultados simulados evitando el acoplo entre las líneas.
\\
...
\begin{table}[H]
   ...
   \midrule
   \textbf{$S_{11}$} & -21.59 dB \\
   \textbf{Ancho de banda} & 792.4 MHz \\
   \textbf{Directividad} & 13.29 dB \\
   \textbf{Ganancia} & 12.93 dB \\
   \textbf{Eficiencia de radiación} & 91.37\% \\
   \textbf{Relación delante/atrás} & 17.23 dB \\
