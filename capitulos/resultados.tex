...
\\
\par En la tabla \ref{tab:2x22} se pueden observar un resumen de los parámetros característicos de la antena.
...
\\
\par En la tabla \ref{tab:4x11} se pueden observar un resumen de los parámetros característicos de la antena.
...
\\
\par En la tabla \ref{tab:4x12} se pueden observar un resumen de los parámetros característicos de la antena.
...
\\
\par En la tabla \ref{tab:4x21} se pueden observar un resumen de los parámetros característicos de la antena.
...
\subsection{Pérdidas de retorno}
\par En cuanto a su curva de pérdidas de retorno del array 4x2 a 6 GHz, se puede observar un valor pico de -32.18 dB y un ancho de banda de 39.6 MHz, desde los 2.3792 GHz hasta los 6186 GHz, lo que equivale a un 1.65\% de la frecuencia de trabajo.
\\
\begin{figure}[H]
    \centering
...
\par Esta configuración es una de las que mas ha costado conseguir adaptar en el proceso de diseño, es por ello que los resultados obtenidos no destacan sobre el resto de arrays. La directividad obtenida ha sido muy buena, pero otros parámetros como la eficiencia o el ancho de banda han dejado que desear sobre esta configuración. 
\\
\par En la tabla \ref{tab:4x22} se pueden observar un resumen de los parámetros característicos de la antena.
