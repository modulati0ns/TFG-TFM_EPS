...
\subsection{Pérdidas de retorno}
\par La curva de pérdidas de retorno o Parámetro $S_{11}$ del Array 2x2 a 27 GHz, donde se puede observar un valor pico de -33.37 dB y un ancho de banda de 590.8 MHz, desde los 26.7024 GHz hasta los 27.2932 GHz, lo que equivale a un 2.18\% de la frecuencia de trabajo.
\\
\begin{figure}[H]
    \centering
