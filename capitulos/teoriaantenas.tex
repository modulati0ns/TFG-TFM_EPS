...
\centering
    ...
    \centering
        ...
        \caption{Antena Yagi para recepción de TDT}
        \label{fig:yagi}
	\end{subfigure}
~ % Añadir el espacio deseado, si se deja la linea en blanco la siguiente subfigura ira en una nueva linea
	\begin{subfigure}[b]{0.5\textwidth} % Espacio horizontal ocupado por la subfigura
	\centering
		\includegraphics[width=6cm]{archivos/yagipat} % Tamaño de la imagen
...
\\
\par A efectos prácticos, obtendremos un dipolo de media onda con una impedancia igual a la mitad del dipolo original. El diagrama de radiación contendrá solo la parte superior del toroide obtenido en el dipolo pero con el doble de intensidad de radiación que en este, es decir, con una ganancia 3dB mayor (fig. \ref{fig:monopolorad}).
\\
\begin{figure}[h]
    \centering
        \includegraphics[width=14cm]{archivos/monopolo/monoesquema}
        \caption{Esquema de instalación de un monopolo}
        \label{fig:monopolo}
\end{figure}
...
\begin{figure}[h]
    \centering
        ...
        \caption{Monopolo para transmisión de AM}
...
\begin{figure}[h]
    \centering
        ...
        \caption{Bocina para comunicación satelital construida en 1959 por los laboratorios Bell}
        \label{fig:horn}
\end{figure}
...
\begin{figure}[h]
    \centering
        ...
        \caption{Antena parabólica del IRAM en Sierra Nevada, parte del proyecto Event Horizon para capturar la primera fotografía de un agujero negro}
