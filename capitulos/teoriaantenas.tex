...
\par Para saber qué tipo de antena se puede hacer más conveniente para un uso concreto se ha de tener en cuenta sus características. Las principales características de las antenas son: \cite{Carcamo2014, Cardama2002, JaumeAnguera2008}
...
\begin{figure}[h]
    \centering
        ...
        \label{fig:carte}
\end{figure}
\todo{referencia de la imagen de los patrones a donde?}
