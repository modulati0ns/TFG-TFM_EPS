...
\begin{figure}[h]
    \centering
       \includegraphics[width=9cm]{archivos/maxwell}
        \caption{James Clerk Maxwell (1831 - 1879). \citep{StodartCirca.1890} }
        \label{fig:maxwell}
\end{figure}
...
\begin{figure}[h]
    \centering
       \includegraphics[width=15cm]{archivos/oem}
        \caption{Representación esquemática de una Onda Electromagnética. \citep{Toppr2017}}
        \label{fig:oem}
\end{figure}
...
\begin{figure}[h]
    \centering
        ...
        \caption{Martin Cooper (Motorola) junto a teléfonos móviles de primera generación. \citep{Huffaker2009}}
        \label{fig:motorola}
\end{figure}
...
\begin{figure}[H]
    \centering
        ...
        \caption{Stadika: Concepto de diseño de Small Cells 5G para la ciudad de Helsinki. \citep{Muesa2019}}
        \label{fig:stadika}
\end{figure}
