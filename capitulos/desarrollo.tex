...
\begin{figure}[h]
    \centering
        \includegraphics[width=0.8\textwidth]{archivos/desarrollo/4}
...
\item \textbf{Distribución eléctrica sobre la antena: }otro tipo de análisis que podemos realizar sobre la antena consiste en la muestra directa sobre la antena de ciertos parámetros como el campo eléctrico, los vectores de los campos eléctricos y magnéticos, etc. En este caso, se muestra la distribución del campo eléctrico sobre la antena. En el se pueden observar dónde se sitúan los principales valles y nodos sobre esta. Es importante mencionar que los campos eléctricos mostrados en la figura \ref{fig:Complexmage} así como todos los que se mostrarán en el capítulo \ref{resultados} están referidos a una potencia de entrada en la línea de transmisión principal de 1 W.
\vfill
	\begin{figure}[H]
    \centering
...
\subsubsection{Antenas a 27 GHz}
