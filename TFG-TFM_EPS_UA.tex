...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Título y subtítulo
\newcommand{\titulo}{Diseño y Análisis de un Array de Antenas tipo Parche en Tecnología Microstrip}
\newcommand{\subtitulo}{}
% Datos del autor
...
\newcommand{\miTutorB}{Miguel Ángel Sanchez Soriano}
...
%\input{capitulos/teoriaantenas}	% Plantilla: Se muestran listas
%\input{capitulos/antenasmicrostrip}		% Plantilla: Se muestran tablas
\input{capitulos/teoriaarrays}	% Plantilla: Se muestran figuras
